...
// Brand and Client Slider
$(document).ready(function() {
    $('.brand_client_slider').owlCarousel({
        nav: true,
        margin: 0,
        dots: false,
        autoplay: true,
...
$(".search0").click(function() {
    $(".search_form_wrp_sec_0").toggle();
});
$(".search1").click(function() {
    $(".search_form_wrp_sec_1").toggle();
});
$(".search2").click(function() {
    $(".search_form_wrp_sec_2").toggle();
});
$(".search3").click(function() {
    $(".search_form_wrp_sec_3").toggle();
});
$(".search4").click(function() {
    $(".search_form_wrp_sec_4").toggle();
});
$(".search5").click(function() {
    $(".search_form_wrp_sec_5").toggle();
});
$(".search6").click(function() {
    $(".search_form_wrp_sec_6").toggle();
});
$('.product_Slider').on('initialized.owl.carousel changed.owl.carousel', function(e) {
    if (!e.namespace) {
        return;
    }
    var carousel = e.relatedTarget;
    $('.sld_counter').text(carousel.relative(carousel.current()) + 1 + '/' + carousel.items().length);
}).owlCarousel({
    items: 1,
    loop: true,
    margin: 0,
...
//        if ($('#mobile_text_id' + tr).text() == 'EXPAND >') {
//            $('#hide_cft_img_1' + tr).hide();
//            $('#ct_des_width' + tr).css('width', '100%');
//        } else if ($('#mobile_text_id' + tr).text() == 'Close∧') {
//            $('#hide_cft_img_1' + tr).show();
//            $('#ct_des_width' + tr).css('width', '65%');
//        }
