    ...
    return e
            ...
            var h = a("./AbstractModule"), i = d(h), j = function(a) {
                function b(c) {
                    e(this, b);
                    var d = f(this, a.call(this, c));
                    return d.currentSlide = 1, d.isAnimating = !1, d.animationDuration = 1200, d.autoplaySpeed = 1e4, d.interval, d.maxSlide = d.$el.find($(".js-slider-home-slide")).length, d.$controls = d.$el.find(".js-slider-home-button"), d.$el.on("click", ".js-slider-home-next", function(a) {
                        return d.nextSlide()
                    }), d.$el.on("click", ".js-slider-home-prev", function(a) {
                        return d.prevSlide()
                    }), d.startAutoplay(), d
