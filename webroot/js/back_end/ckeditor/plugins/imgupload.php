...
$upload_dir = '/app/webroot/img/article_contents/';
//$upload_dir='http://' . $_SERVER['HTTP_HOST'] . $this->base . '/app/webroot/img/extra_images/';
//$upload_dir=Router::url('/app/webroot/img/extra_images/',true);
