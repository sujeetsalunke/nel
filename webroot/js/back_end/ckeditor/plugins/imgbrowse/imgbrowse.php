...
class imgbrowse {   
  ...
  protected $root ='/app/webroot/img/article_contents/';
  //protected $root = 'http://localhost/proj_glossary/app/webroot/img/extra_images/'; 
  //protected $root=Router::url('/app/webroot/img/extra_images/',true);
