            ...
            <div class="box box-info">
                <div class="box box-solid">
                    <div class="box-body layout-top-nav">
                        <span class="eg">Edit Color Images</span>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-collapse">
                                        <ul class="nav navbar-nav">
                                            <li><a href="javascript:;">Product Color Image <span class="sr-only"></span></a></li>
                                            <li class="active"><a href="javascript:;">Product Color Image <span class="sr-only"></span></a></li>                                     
                                        </ul>
                                    </div><!-- /.navbar-collapse -->
                                </div><!-- /.container-fluid -->
                            </nav>
                ...
                <!-- form start -->
                <?php echo $this->Form->create($productColorImage, array('type' => 'file', 'role' => 'form', 'id' => 'edit_page')); ?>
                <div class="box-body">
                    ...
                    <?php if (!empty($productColorImage['image'])): ?>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-lg-3 control-label">Old Color Image:<span class="required" aria-required="true"> * </span></label>
                                <div class="col-lg-5">                                 
                                    <?php echo $this->Html->image('product/details/color_image/' . $productColorImage['image'], array('height' => '40%', 'width' => '40%')); ?>                                                          
                                </div>                                               
                            </div>
                        </div>
                    <?php endif; ?>
                    <div class="form-group">
                        <div class ="row">
                            ...
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('new_image', array('type' => 'file', 'id' => '', 'class' => 'form-control', 'placeholder' => 'Select image', 'label' => false)); ?>
                            </div>
                ...
                <div class="box-footer">
                    ...
                    <div class="col-lg-1">
                        <?= $this->Html->link(__('Cancel'), ['controller' => 'ProductColorImages', 'action' => 'add', $productColorImage['product_detail_id']], ['class' => 'btn  btn-warning pull-right', 'escape' => false]) ?>
                    </div>
                </div>
