    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- form start -->
                <?php echo $this->Form->create($projectDetail, array('type' => 'file', 'role' => 'form', 'id' => 'add_page')); ?>
                <div class="box-body">
                    <div class="form-group">
                        <div class ="row">
                            <label class="col-lg-3 control-label">Project Name<span class="required" aria-required="true"> * </span></label>
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('project_id', array('options' => $Projects, 'empty' => 'Select Project Name', 'class' => 'form-control', 'label' => false, 'data-bvalidator' => 'required')); ?>
                            </div>
                        </div>
                    </div>  
                    <?php if (!empty($projectDetail['image'])): ?>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-lg-3 control-label">Old Image:</label>
                                <div class="col-lg-5">                                 
                                    <?php echo $this->Html->image('project/details/' . $projectDetail['image'], array('height' => '40%', 'width' => '40%')); ?>                                                          
                                </div>                                               
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        <div class ="row">
                            <label class="col-lg-3 control-label">Text Details<span class="required" aria-required="true"> * </span></label>
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('text_details', array('class' => 'form-control ckeditor', 'placeholder' => 'Enter Text Details', 'label' => false, 'data-bvalidator' => 'required')); ?>
                            </div>
                        </div>
                    </div>                     
                    <div class="form-group">
