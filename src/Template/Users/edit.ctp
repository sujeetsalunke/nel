    ...
    $(document).ready(function() {
        ...
        $('#email').blur(function() {
            ...
            if (email_id != '') {
                ...
                var urls = base_path + "users/check_email/" + email_id + '/' + user_id;
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group" hidden>
                        <div class ="row">                         
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('id', array('class' => 'form-control', 'id' => 'user_id', 'label' => false)); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" hidden>
                        <div class ="row">
                            ...
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('role', array('class' => 'form-control', 'placeholder' => 'Enter Role', 'label' => false, 'data-bvalidator' => 'required')); ?>
                            </div>
                        </div>
                    </div>                  
                    <div class="form-group">
