        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <?php if (!empty($client['desktop_image'])): ?>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-lg-3 control-label">Old Desktop Image:</label>
                                <div class="col-lg-5">                                 
                                    <?php echo $this->Html->image('client/' . $client['desktop_image'], array('height' => '40%', 'width' => '40%')); ?>                                                          
                                </div>                                               
                            </div>
                        </div>
                    <?php endif; ?>
                    <div class="form-group">
                        <div class ="row">
                            ...
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('desktop_image_new', array('type' => 'file', 'id' => 'desktop_image', 'class' => 'form-control', 'placeholder' => 'Select Desktop image', 'label' => false)); ?>
                            </div>
                    ...
                    <?php if (!empty($client['mobile_image'])): ?>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-lg-3 control-label">Old Desktop Image:</label>
                                <div class="col-lg-5">                                 
                                    <?php echo $this->Html->image('client/' . $client['mobile_image'], array('height' => '40%', 'width' => '40%')); ?>                                                          
                                </div>                                               
                            </div>
                        </div>
                    <?php endif; ?>
                    <div class="form-group">
                        <div class ="row">
                            ...
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('mobile_image_new', array('type' => 'file', 'id' => 'mobile_image', 'class' => 'form-control', 'placeholder' => 'Select Mobile image', 'label' => false)); ?>
                            </div>
                            <span style="color:red" class="error" id="Msg" hidden>Image should be 1905 X 567 (pixel).</span>
                            <span style="color:red" class="error" id="img_error1" hidden>Image dimensions not valid, Image should be 1905 X 567 (pixel).</span>
                            <span style="color:red" class="error" id="img_error3" hidden>Image extension not valid, Image should be png,jpeg,jpg.</span>
