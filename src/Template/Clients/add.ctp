    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- form start -->
                <?php echo $this->Form->create($client, array('type' => 'file', 'role' => 'form', 'id' => 'add_page')); ?>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class ="row">
                            <label class="col-lg-3 control-label">Select Mobile Image<span class="required" aria-required="true"> * </span></label>
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('mobile_image', array('type' => 'file', 'id' => 'image_mobile_2', 'class' => 'form-control', 'placeholder' => 'Select Mobile image', 'label' => false, 'data-bvalidator' => 'required')); ?>
                            </div>
                    ...
                    <div class="form-group">
                        <div class ="row">
                            <label class="col-lg-3 control-label">Select Desktop Image<span class="required" aria-required="true"> * </span></label>
                            <div class="col-lg-5">
                                <?php echo $this->Form->input('desktop_image', array('type' => 'file', 'id' => 'image_desktop_2', 'class' => 'form-control', 'placeholder' => 'Select Desktop image', 'label' => false, 'data-bvalidator' => 'required')); ?>
                            </div>
                            <span style="color:red" class="error" id="Msg" hidden>Image should be 1905 X 567 (pixel).</span>
                            <span style="color:red" class="error" id="img_error1" hidden>Image dimensions not valid, Image should be 1905 X 567 (pixel).</span>
                            <span style="color:red" class="error" id="img_error3" hidden>Image extension not valid, Image should be png,jpeg,jpg.</span>
