 ...
 * @method \App\Model\Entity\ProjectDetail|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class ProjectDetailsTable extends Table {
    ...
    public function validationDefault(Validator $validator) {
        ...
        $validator
                ->scalar('text_details')
                ->requirePresence('text_details', 'create')
                ->notEmpty('text_details');
    ...
    public function uploadImage($image = null) {
        ...
        $upload_path = "img/project/details";
