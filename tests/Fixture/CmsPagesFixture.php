 ...
 *
 */
class CmsPagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'meta_keyword' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2017-09-16 11:38:59',
            'modified' => '2017-09-16 11:38:59'
        ],
    ];
}
